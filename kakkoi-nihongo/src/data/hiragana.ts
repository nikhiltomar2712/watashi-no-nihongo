...
export const hiraganaChars: KanaChar[] = [
  ...
  { hiragana: 'を', katakana: 'ヲ', romaji: 'o' },
  { hiragana: 'ん', katakana: 'ン', romaji: 'n' },
];

export const hiraganaDakuten: DakutenHandakutenChar[] = [
...
export const hiraganaHandakuten: DakutenHandakutenChar[] = [
...
export const hiraganaYoon: YoonChar[] = [
